	                                ...
	                                <div class="content_sidebar content_sidebar_grid">
	                                    <div class="sidebar_default category_grid">
	                                        ...
	                                        <ul class="category_sidebar_grid">
	                                            <li><a href="${pageContext.request.contextPath }/ProductListController?optionVal=0&p_cate1=4&p_cate2=14"><span class="text">쉐이커 & 물통</span></a></li>
	                                            <li><a href="${pageContext.request.contextPath }/ProductListController?optionVal=0&p_cate1=4&p_cate2=15"><span class="text">장갑 & 벨트 & 스트랩</span></a></li>
	                                            <li><a href="${pageContext.request.contextPath }/ProductListController?optionVal=0&p_cate1=4&p_cate2=16"><span class="text">관절 보호대</span></a></li>
	                                            <li><a href="${pageContext.request.contextPath }/ProductListController?optionVal=0&p_cate1=4&p_cate2=17"><span class="text">피트니스 용품</span></a></li>
	                                        </ul>
	                                    </div>
	                                </div>
	                            </div>
	                                                	...
	                                                	<c:forEach var="i" items="${list }">
		                                                    <div class="col-md-4 col-sm-6 col-xs-6 col-mb-12">
		                                                        <div class="product_wrap blog blog_list">
		                                                            <div class="product">
		                                                                <a href="${pageContext.request.contextPath }/ProductViewController?num=${i.p_num }&cate1=5" class="product">
		                                                            ...
		                                                            <div class="caption">
		                                                                <div class="tittle_product">
		                                                                    <a href="${pageContext.request.contextPath }/ProductViewController?num=${i.p_num }&cate1=5">${i.p_name}</a>
		                                                                </div>
		                                                                ...
		                                                                <div class="cart">
		                                                                    <a href="${pageContext.request.contextPath }/ProductViewController?num=${i.p_num }&cate1=5">상세보기</a>
		                                                                </div>
		                                                            </div>
		                                                        </div>
		                                                    </div>
