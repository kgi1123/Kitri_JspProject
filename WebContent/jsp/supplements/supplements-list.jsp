		...
		<section>
	        <div class="main_content">
	            <div class="container-full">
	            	...
	            	<!-- 배너 -->
	                <jsp:include page="/jsp/supplements/supplements-banner.jsp" />
	                <div class="container-full">
	                    <div class="container">
	                        <div class="row">
	                            <div class="col-md-3">
	                                <div class="content_sidebar content_sidebar_grid">
	                                    <div class="sidebar_default category_grid">
	                                        ...
	                                        <ul class="category_sidebar_grid">
	                                            <li><a href="${pageContext.request.contextPath }/ProductListController?optionVal=0&p_cate1=1&p_cate2=1"><span class="text">운동전(부스터)</span></a></li>
	                                            <li><a href="${pageContext.request.contextPath }/ProductListController?optionVal=0&p_cate1=1&p_cate2=2"><span class="text">운동중(지구력)</span></a></li>
	                                            <li><a href="${pageContext.request.contextPath }/ProductListController?optionVal=0&p_cate1=1&p_cate2=3"><span class="text">운동후(회복)</span></a></li>
	                                        </ul>
	                                    </div>
	                                </div>
	                            </div>
							                	...
							                	<c:forEach var="i" items="${list }">
							                    	<div class="col-md-4 col-sm-6 col-xs-6 col-mb-12">
							                        	<div class="product_wrap blog blog_list">
							                            	<div class="product">
							                                	<a href="${pageContext.request.contextPath }/ProductViewController?num=${i.p_num }&cate1=1" class="product">
							                            	...
							                            	<div class="caption">
							                                	<div class="tittle_product">
							                                    	<a href="${pageContext.request.contextPath }/ProductViewController?num=${i.p_num }&cate1=1">${i.p_name}</a>
							                                	</div>
							                                	...
							                                	<div class="cart">
							                                    	<a href="${pageContext.request.contextPath }/ProductViewController?num=${i.p_num }&cate1=1">상세보기</a>
							                                	</div>
							                            	</div>
							                        	</div>
							                    	</div>
