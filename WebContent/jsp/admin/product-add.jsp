...
$(document).ready(function(){
   ...
   $('#product_add_btn').click(function(){
      $('#f').attr('action', "${pageContext.request.contextPath }/ProductAddController");
      $('#f').submit();
   });
});
</script>
                  ...
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header card-header-primary">
                           <h4 class="card-title ">상품추가</h4>
                           <p class="card-category">상품을 등록하세요</p>
                        </div>
                        <div class="card-body">
                           <div class="table-responsive">
                              <form action="#" method="post" id="f" enctype="multipart/form-data">
                                 <table class="table">
                                    ...
                                    <tr>
                                       <td>작성자</td>
                                       <td><input type="text" name="p_writer"></td>
                                    </tr>
                                    <tr>
                                       <td>가격</td>
                                    ...
                                    <tr>
                                       <td>내용</td>
                                       <td><textarea rows="20" cols="70" name="p_contents"></textarea></td>
                                    </tr>
                                    <tr>
                                       <td>이미지</td>
                                    ...
                                    <tr>
                                       <td colspan="2"><button class="btn btn-primary pull-right" id="product_add_btn">등록</button></td>
                                    </tr>
                                 </table>
                              </form>
                           </div>
