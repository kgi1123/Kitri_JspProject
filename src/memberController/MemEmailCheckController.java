 ...
 */
@WebServlet("/MemEmailCheckController")
public class MemEmailCheckController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemEmailCheckController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!signEmail.equals("")) {
			flag = service.check_email(signEmail);
			if(flag) {
				str = "NO";
				out.print(str);
			} else {
